...
| Article | Description |
|---|---|
| [Linkage map construction with ASMap](https://drj001.github.io/ASMap/articles/ASMap.html) | A short introduction: construction from marker scores, the choice of `p.value`, diagnosis of genotypes and markers, and setting markers aside. Also installed with the package as `vignette("ASMap")`. |
...
the basis of the fine mapping workflow described in the articles. For all types other than
...
<details>
<summary><b>Click to expand: the condensed barley backcross workflow</b></summary>
...
The [worked example](https://drj001.github.io/ASMap/articles/worked-example-refinement.html)
continues from here into fine mapping, combining maps of the same population, and
resolving unknown linkage groups.
