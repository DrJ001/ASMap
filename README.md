...
A book-length guide to the package, including a fully worked barley backcross example
that runs from pre-construction diagnostics through construction to post-construction
map improvement, fine mapping and map combining.
...
The vignette is succinctly summarised in the *Journal of Statistical Software* paper
