...
- [Getting started with
  ...
  Build a linkage map from a set of marker scores in a few lines, then
  find your way around the rest of the documentation.
...
- [Pulling and pushing
  ...
  reintroducing them afterwards, instead of discarding them permanently.
...
- [How the MSTmap algorithm
  ...
  The minimum spanning tree formulation behind ASMap: how markers are
  clustered into linkage groups, how they are ordered within a group,
  and how missing scores are imputed as part of the same algorithm.
